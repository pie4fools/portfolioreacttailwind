    ...
    <div className='bg-gray-100'>
        ...
        <div className='lg:flex gap-10'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 mx-10 align-center'>
                ...
                <a href='https://chatgptclone-lilac.vercel.app/' target='_blank' rel='noreferrer' className='bg-[#00dfd4] w-[90px] h-[37.5px] rounded-full font-medium mt-7 mx-auto py-2.5 px-6 mr-5 text-white hover:bg-black focus:ring focus:ring-grey-300'>Visit</a>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 mx-10'>
                ...
                <a href='https://master--beautiful-zuccutto-11d061.netlify.app/' target='_blank' rel='noreferrer' className='bg-[#00dfd4] w-[90px] h-[37.5px] rounded-full font-medium mt-7 mx-auto py-2.5 px-6 mr-5 text-white hover:bg-black focus:ring focus:ring-grey-300'>Visit</a>
                <button className='bg-[#00dfd4] w-[90px] h-[37.5px] rounded-full font-medium mt-7 mx-auto pb-0.5 text-white hover:bg-black focus:ring focus:ring-grey-300'>Source</button>
            </div>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 mx-10'>
                ...
                <button className='bg-[#00dfd4] w-[90px] h-[37.5px] rounded-full font-medium mt-7 mx-auto pb-0.5 mr-5 text-white hover:bg-black focus:ring focus:ring-grey-300'>Visit</button>
                <button className='bg-[#00dfd4] w-[90px] h-[37.5px] rounded-full font-medium mt-7 mx-auto pb-0.5 text-white hover:bg-black focus:ring focus:ring-grey-300'>Source</button>
            </div>
            <div className='sm:mb-0 text-center shadow-lg p-10 rounded-xl lg:my-10 mx-10'>
                ...
                <a href='http://www.pristinecleaningph.com/' target='_blank' rel='noreferrer' className='bg-[#00dfd4] w-[90px] h-[37.5px] rounded-full font-medium mt-7 mx-auto py-2.5 px-6 mr-5 text-white hover:bg-black focus:ring focus:ring-grey-300'>Visit</a>
                <button className='bg-[#00dfd4] w-[90px] h-[37.5px] rounded-full font-medium mt-7 mx-auto pb-0.5 text-white hover:bg-black focus:ring focus:ring-grey-300'>Source</button>
            </div>
        </div>
    </div>
