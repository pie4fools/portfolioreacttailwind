    ...
    <div className='bg-gray-100'>
        <div className='lg:flex gap-10'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 mx-10 align-center'>
                ...
                <button className='bg-[#00dfd4] w-[90px] h-[37.5px] rounded-full font-medium mt-7 mx-auto text-white hover:bg-black focus:ring focus:ring-grey-300'>Source</button>
            </div>
